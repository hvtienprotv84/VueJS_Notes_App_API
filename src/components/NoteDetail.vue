    ...
    <q-page class="flex flex-center">
        <q-card v-if="isEditing" flat bordered class="my-card">
            ...
            <q-card-section>
                <q-form @submit.prevent="handleSubmit">
                    ...
                    <div class="q-my-md"><label class="typo__label" v-if="notesStore.tags.length > 0">Danh Mục Thẻ</label>
                        <multiselect 
                            class="q-my-md" 
                            v-model="note.tags" 
                            placeholder="Search" 
        ...
        <q-card v-else class="my-card q-mt-md" flat bordered>
            ...
            <q-card-actions>
                ...
                <q-btn color="negative" type="button" size="sm" @click="confirm(note.id)">Xóa</q-btn>
            </q-card-actions>
        </q-card>
